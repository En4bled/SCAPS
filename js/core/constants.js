...
export const CONFIG = {
    ...
    CAR_ACCEL: 0.03,
    CAR_MAX_SPEED: 2.5,
    CAR_BOOST_ACCEL: 0.06,
    CAR_TURN_SPEED: 0.035,
    CAR_FRICTION: 0.98,
    CAR_WIDTH: 40,
    CAR_HEIGHT: 70,
    CAR_HITBOX_RADIUS: 30,
    CAR_REVERSE_ACCEL: 0.05,
    CAR_MAX_BOOST_SPEED: 4.5,
    CAR_BOOST_CONSUMPTION: 0.40,
    CAR_DRIFT_TURN_MULTIPLIER: 1.8,
    CAR_CAR_PUSHBACK_BASE: 0.5,
    CAR_CAR_PUSHBACK_VEL_FACTOR: 0.3,

    // Físicas de Balón
    BALL_BOUNCINESS: 0.85,
    BALL_FRICTION: 0.995,
    BALL_HIT_FORCE: 3.0,
    BALL_MAX_SPEED: 18,
    BALL_BASE_RADIUS: 55,
    BALL_WALL_SLOWDOWN_FACTOR: 0.5,
