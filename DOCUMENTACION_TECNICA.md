...
### 2.2. Physics Engine (`js/world/physics.js`)
The physics module handles spatial partitioning and collision resolution. Currently running on the **Core Production V12 Engine**.
- **Collision Detection**: 
...
### 2.3. Autonomous Intelligence: Core Production
The AI module (`updateCarAI`) implements a hyper-optimized deterministic pursuit algorithm. See [IA_SCAPS_CORE.md](./IA_SCAPS_CORE.md) for details.
